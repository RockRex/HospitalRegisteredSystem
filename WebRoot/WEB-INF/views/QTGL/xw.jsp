...
$(function(){
	 $(".Delete").click(function(){
		...
		var flag = confirm("确定要删除"+ name +"的这条新闻吗？");
  ...
  <body>
  <form action="NoticeAction-search" method="post">
            ...
            <tr>
              ...
              <td width="60"><table width="90%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td class="STYLE1"><div align="center"><a href="NoticeAction-add">新增</a></div></td>
                  </tr>
              </table></td>
            </tr>
          </table>
  ...
  <tr>
    ...
    按照标题<input type="text" id="key1" name="key1"/>&nbsp;&nbsp;&nbsp;
    按照日期：<input type="text" id="key2" name="key2" class="Wdate" onClick="WdatePicker({highLineWeekDay:true,readOnly:true})"/>&nbsp;&nbsp;&nbsp;
  <input type="submit" value="查询" /></span>
      ...
      <tr>
        ...
        <td height="22" bgcolor="#FFFFFF"><div align="center"><strong><span class="STYLE1">操作</span></strong></div></td>
      	...
      	<s:if test="#request.notices == null || #request.notices.size() == 0">
		...
		<s:else>
			<s:iterator value="#request.notices">
				<tr>
					...
					<div align="center"><span class="STYLE3">${noticeId}</span></div>
					</td>
        			<td height="22" bgcolor="#FFFFFF">
        			<div align="center"><span class="STYLE3">
        			<a href="NoticeAction-look?id=${noticeId}">${noticeTitle}</a>
        			</span></div>
        			</td>
        			<td height="22" bgcolor="#FFFFFF">
        			<div align="center"><span class="STYLE3">${noticeSavetime}</span></div>
        			</td>
        			<td height="22" bgcolor="#FFFFFF">
        			<div align="center"><span class="STYLE3">
        			<a href="NoticeAction-look?id=${noticeId}">查看</a>
        			&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
        			<a href="NoticeAction-input?id=${noticeId}">修改</a>
        			&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
        			<a href="NoticeAction-delete?id=${noticeId}" class="Delete">删除</a>
        			<input type="hidden" value="${noticeTitle}"/>
        			</span></div>
        			</td>
				</tr>
			</s:iterator>
