...
$(function(){
  ...
  <body>
  <form action="DepartmentAction-search" method="post">
            ...
            <tr>
              ...
              <td width="60"><table width="90%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td class="STYLE1"><div align="center"><a href="DepartmentAction-add">新增</a></div></td>
                  </tr>
              </table></td>
            </tr>
          </table>
  ...
  <tr>
    ...
    <th colspan="3"><span class="STYLE1">科室名称或类别：<input type="text" id="key" name="key" />&nbsp;&nbsp;&nbsp;
      ...
      <tr>
        ...
        <td height="22" bgcolor="#FFFFFF"><div align="center"><strong><span class="STYLE1">简介</span></strong></div></td>
        <td height="22" bgcolor="#FFFFFF"><div align="center"><strong><span class="STYLE1">操作</span></strong></div></td>
      	...
      	<s:if test="#request.departments == null || #request.departments.size() == 0">
				<tr><td colspan="4">没有任何科室信息</td></tr>
		</s:if>
		<s:else>
			<s:iterator value="#request.departments">
				<tr>
					<td height="22" bgcolor="#FFFFFF">
					<div align="center"><span class="STYLE3">${departmentName}</span></div>
					</td>
        			<td height="22" bgcolor="#FFFFFF">
        			<div align="center"><span class="STYLE3">${departmentType}</span></div>
        			</td>
        			<td height="22" bgcolor="#FFFFFF">
        			<div align="center"><span class="STYLE3">${departmentRemark}</span></div>
        			</td>
        			<td height="22" bgcolor="#FFFFFF">
        			<div align="center"><span class="STYLE3">
        			<a href="DepartmentAction-input?id=${departmentId}">修改</a>
        			&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
        			<a href="DepartmentAction-delete?id=${departmentId}" class="Delete">删除</a>
