...
-->
  ...
  <body>
  <form action="WorkforceAction-save" method="post" name="f1" onsubmit="return ck()">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#c9c9c9">
      <tr>
        <td height="22" bgcolor="#FFFFFF">
        	<div align="center"><span class="STYLE3">医生姓名</span></div>
        </td>
        <td height="22" bgcolor="#FFFFFF">
        	<div><span class="STYLE3">
        	<s:select list="#request.doctors" 
					listKey="doctorId" listValue="doctorName" name="doctor.doctorId" >
			</s:select>	
			<s:textfield  name="workforceId" id="workforceId" type="hidden"></s:textfield>
        	</span></div>
        </td>
      </tr>
      <tr>
