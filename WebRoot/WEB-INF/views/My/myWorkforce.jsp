...
$(function(){
  ...
  <body>
  <form action="WorkforceAction-mysearch" method="post">
            ...
            <tr>
              ...
              <td width="60"><table width="90%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td class="STYLE1"><div align="center"><a href="WorkforceAction-myadd">新增</a></div></td>
                  </tr>
              </table></td>
            </tr>
          </table>
  ...
  <input type="submit" value="查询" /></span>
      ...
      <tr>
        ...
        <td height="22" bgcolor="#FFFFFF"><div align="center"><strong><span class="STYLE1">剩余名额</span></strong></div></td>
		...
		<s:else>
			<s:iterator value="#request.workforces">
				<tr>
        			...
        			<a href="WorkforceAction-myinput?id=${workforceId}">修改</a>
        			&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
