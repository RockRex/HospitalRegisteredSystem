...
$(function(){
  ...
  <body>
  <form action="AppointmentAction-mysearch" method="post">
  ...
  <tr>
    ...
    <input type="hidden" id="key4" name="key4" value="待诊"/>
		...
		<s:else>
			<s:iterator value="#request.appointments">
				<tr>
        			...
        			<td height="22" bgcolor="#FFFFFF"><div align="center">
        			<span class="STYLE3">
        			<a href="AppointmentAction-done?id=${appointmentId}" class="Done">完成</a>
